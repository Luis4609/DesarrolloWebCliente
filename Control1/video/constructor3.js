/*
los atributos son privados al poner var, debemos definir en el mismo ambito los get/set
*/
...
class Video{
	...
	constructor(ns,a,b,c,d,e,f) {
		...
		this.vistas = (function(){
			var contador=f; return function (){contador+=1;return contador}
		})();
...
/* OPCION2
		...
		Object.defineProperty(this,"vid",{get:function(){return _vid;},set:function(x){_vid=x;}});
*/

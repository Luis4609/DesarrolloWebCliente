    ...
    <tr>
        <td>
            <form name="registro" action="registro.php" method="post">
                <div align="center"><b>
                        <h1>
                            <font color="#000080">FORMULARIO DE REGISTRO</font>
                        </h1>27/11/2014
                    </b><br><br>
                    <table border="0" cellspacing="3" summary="">
                        <tr>
                            <td><b>Nombre<font size="2">(*)</font>:</b></td>
                            <td><input type="text" name="Nombre" value="" size="30" maxlength="50"></td>
                        </tr>
                        <tr>
                            <td><b>Apellidos:</b></td>
                            <td><input type="text" name="Apellidos" value="" size="30" maxlength="50"></td>
                        </tr>
                        <tr>
                            <td><b>F.Nacimiento<font size="2">(*)</font>:</b></td>
                            <td>
                                <table border="0" summary="">
                                    ...
                                    <tr>
                                        <td><input type="text" name="Dia" size="2" value="" maxlength="2"></td>
                                        <td><input type="text" name="Mes" size="2" value="" maxlength="2"></td>
                                        <td><input type="text" name="Ano" size="2" value="" maxlength="4"></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td><b>Población:</b></td>
                            <td><input type="text" name="Poblacion" value="" size="30" maxlength="50"></td>
                        </tr>
                        <tr>
                            <td><b>Provincia<font size="2">(*)</font>:</b></td>
                            <td><input type="text" name="Provincia" value="" size="30" maxlength="50"></td>
                        </tr>
                        <tr>
                            <td><b>T.Fijo:</b></td>
                            <td><input type="text" name="Tfijo" value="" size="15" maxlength="20"></td>
                        </tr>
                        <tr>
                            <td><b>T.Móvil:</b></td>
                            <td><input type="text" name="Tmovil" value="" size="15" maxlength="20"></td>
                        </tr>
                        <tr>
                            <td><b>Título Buceo:</b></td>
                            <td><select name="Tbuceo">
                                    <option value="-">-</option>
                                    <option value="PADI-OWD">PADI-OWD</option>
                                    <option value="PADI-AOWD">PADI-AOWD</option>
                                    <option value="PADI-ROWD">PADI-ROWD</option>
                        ...
                        <tr>
                            <td><b>e-mail<font size="2">(*)</font>:</b></td>
                            <td><input type="text" name="email" value="" size="50" maxlength="100"></td>
                        </tr>
                        <tr>
                            <td><b>Página WEB:</b></td>
                            <td><input type="text" name="pweb" value="" size="50" maxlength="100"></td>
                        </tr>
                        <tr>
                            <td>
                                <hr>
                        ...
                        <tr>
                            <td><b>Usuario<font size="2">(*)</font>:</b></td>
                            <td><input type="text" name="Usuario" value="" size="15" maxlength="30"></td>
                        </tr>
                        <tr>
                            <td align="right"><input type="checkbox" name="Blog" value="1" checked></td>
                            <td><b>Alta automática en el <a href="http://blog.madridsub.com" target="_blank">Blog Madridsub</a></b></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td width="400"><b>Recibirá su password en la dirección de correo electrónico que ha introducido en este formulario</b></td>
                        </tr>
                        <tr>
                            <td>
                                <hr>
